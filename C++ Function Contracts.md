...
* Others have preconditions:
  ...
  * Contract checks should not affect control flow
  * Contract checks are not input validation
  * Contract checks do not replace unit testing (it complements it)
  * Unit tests verify postconditions in essence
